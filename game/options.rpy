...
define config.name = _("Шепот сердца")
...
define gui.about = _p("""\"Шепот сердца\" - это эмоционально захватывающий романтический визуальный роман, который погружает вас в ностальгическое путешествие любви и дружбы. Окунитесь в трогательную историю, в которой вы вновь встречаетесь с вашим дорогим другом детства и открываете глубокие чувства, охватывающие ваше сердце.

Кредиты к заднему фону: Noraneko Games


Кредиты к изображениям персонажей: 利伊
""")
...
define build.name = "ShepotSerdtsa"
...
default preferences.afm_time = 9
...
define config.save_directory = "ShepotSerdtsa-1688076446"
